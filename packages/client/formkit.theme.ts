...
const classes = {
  ...
  'family:button__input': {
    ...
    border: true,
    'border-priorb-600': true,
    'text-priorb-600': true,
    'group-[]/repeater:shadow-sm': true,
    'group-[]/multistep:shadow-sm': true,
    'dark:border-priorb-500': true
  },
  'family:box__wrapper': {
    'inline-flex': true,
    'items-center': true,
  ...
  'family:box__decorator': {
    ...
    'bg-white': true,
    'ring-priorb-200': true,
    'peer-checked:border-priorb-600': true,
    relative: true,
    block: true,
    'text-lg': true,
    'w-[1em]': true,
    ...
    'peer-checked:bg-priorb-50': true,
    'peer-checked:text-priorb-600': true,
    ...
    'dark:ring-offset-priorb-200': true,
    'dark:peer-focus-visible:ring-1': true,
    'dark:peer-disabled:bg-neutral-600/50': true,
    'dark:peer-checked:bg-priorb-900': true,
    'dark:peer-checked:text-priorb-400': true
  },
  ...
  'family:text__inner': {
    ...
    'focus-within:!ring-priorb-50': true,
    'focus-within:!border-priorb-500': true,
  ...
  'family:dropdown__inner': {
    ...
    'focus-within:ring-1': true,
    'focus-within:!ring-priorb-200': true,
    'focus-within:!border-priorb-500': true,
    'group-data-[invalid]:border-red-500': true,
    'group-data-[invalid]:ring-1': true,
    'group-data-[invalid]:ring-red-500': true,
  ...
  'family:dropdown__listitem': {
    ...
    'text-neutral-700': true,
    'text-base': true,
    'data-[is-active]:bg-priorb-100': true,
    ...
    'data-[is-active]:before:ring-priorb-200': true,
  ...
  'family:dropdown__tagWrapper': {
    ...
    'data-[active-selection=true]:ring-priorb-200': true
  },
  ...
  'family:dropdown__tag': {
    ...
    'group-data-[active-selection=true]/tag:bg-priorb-400': true,
  ...
  'family:dropdown__emptyMessage': {
    ...
    'aria-selected:bg-priorb-600': true
  },
  button__input: {
    'appearance-none': true,
    '[color-scheme:light]': true,
    ...
    'group-data-[has-overlay]:selection:!text-transparent': true,
    'bg-priorb-50': true,
    'hover:bg-priorb-100': true,
    'dark:text-gray-900': true,
    'dark:bg-transparent': true,
    'dark:hover:bg-priorb-50/5': true
  },
  checkbox__decorator: {
    rounded: true
  },
  ...
  color__inner: {
    ...
    'group-data-[prefix-icon]:border-neutral-200': true,
    'group-data-[suffix-icon]:border': true,
    'group-data-[suffix-icon]:border-neutral-200': true,
  ...
  date__input: {
    ...
    'selection:text-neutral-700': true,
    'group-data-[has-overlay]:selection:!text-transparent': true,
    'focus:[&::-webkit-datetime-edit-day-field]:bg-priorb-100': true,
    'focus:[&::-webkit-datetime-edit-month-field]:bg-priorb-100': true,
    'focus:[&::-webkit-datetime-edit-year-field]:bg-priorb-100': true
  },
  'datetime-local__input': {
    ...
    'focus:[&::-webkit-datetime-edit-month-field]:bg-priorb-100': true,
    'focus:[&::-webkit-datetime-edit-year-field]:bg-priorb-100': true,
    'focus:[&::-webkit-datetime-edit-hour-field]:bg-priorb-100': true,
    'focus:[&::-webkit-datetime-edit-minute-field]:bg-priorb-100': true,
    'focus:[&::-webkit-datetime-edit-ampm-field]:bg-priorb-100': true
  },
  file__fileList: {
    'group/list': true,
    peer: true,
  ...
  file__fileRemove: {
    ...
    'peer-data-[has-multiple]:text-priorb-600': true,
  ...
  range__input: {
    ...
    '[&::-webkit-slider-thumb]:bg-priorb-600': true,
    ...
    '[&::-webkit-slider-thumb]:focus:!ring-priorb-200': true,
    ...
    '[&::-moz-range-thumb]:bg-priorb-600': true,
    ...
    '[&::-moz-range-thumb]:focus:!ring-priorb-200': true,
  ...
  select__option: {
    ...
    'group-data-[multiple]:checked:bg-priorb-100': true,
    'group-data-[multiple]:focus:bg-priorb-100': true,
    ...
    'dark:bg-neutral-800': true,
    'dark:text-neutral-300': true,
    'dark:group-data-[multiple]:focus:bg-priorb-800': true,
    'dark:group-data-[multiple]:checked:bg-priorb-800': true
  },
  select__prefixIcon: {
    flex: true,
    'items-center': true,
  ...
  submit__input: {
    ...
    'bg-priorb-600': true,
    '!text-white': true,
    'active:text-priorb-100': true,
    'active:bg-priorb-700': true,
    'hover:bg-priorb-700': true,
    'disabled:border-neutral-200': true,
  ...
  textarea__inner: {
    ...
    'focus-within:!ring-priorb-200': false,
    'focus-within:!border-priorb-500': false,
    'group-data-[invalid]:border-red-500': true,
    'group-data-[invalid]:ring-1': true,
    'group-data-[invalid]:ring-red-500': true,
    'group-data-[disabled]:bg-neutral-100': true,
  ...
  week__input: {
    ...
    'selection:text-neutral-700': true,
    'group-data-[has-overlay]:selection:!text-transparent': true,
    'focus:[&::-webkit-datetime-edit-week-field]:bg-priorb-100': true,
    'focus:[&::-webkit-datetime-edit-year-field]:bg-priorb-100': true
  },
  ...
  colorpicker__control: {
    ...
    'focus-visible:ring-priorb-200': true
  },
  ...
  colorpicker__fieldGroup: {
    ...
    '[&>input]:selection:bg-priorb-100': true,
    '[&>input]:m-0': true,
    '[&>input]:grow': true,
    '[&>input]:shrink': true,
    '[&>input]:w-full': true,
    ...
    '[&>input:focus]:border-priorb-600': true,
  ...
  colorpicker__swatch: {
    ...
    '[&>canvas:focus-visible]:ring-priorb-200': true,
  ...
  datepicker__dayCell: {
    ...
    'dark:bg-neutral-600': true,
    'dark:text-neutral-300': true,
    'dark:aria-selected:bg-priorb-600': true,
    'dark:aria-selected:text-white': true,
    'dark:focus:outline-priorb-600': true,
  ...
  datepicker__timeInput: {
    ...
    'p-1.5': true,
    'my-2.5': true,
    'focus-visible:outline-priorb-600': true,
    'dark:text-neutral-300': true,
    'dark:bg-transparent': true,
    'dark:border-neutral-600': true
  },
  ...
  datepicker__dayButton: {
    ...
    'dark:text-neutral-300': true,
    'dark:border-neutral-600': true,
    'dark:hover:border-priorb-500': true
  },
  ...
  datepicker__calendarIcon: {
    'text-neutral-600': true,
    'focus-visible:text-priorb-600': true,
    flex: true,
    'w-[1em]': true,
    'grow-0': true,
    'shrink-0': true,
  ...
  rating__ratingItem: {
    ...
    'focus-within:outline-priorb-600': true,
    'w-[1.5em]': true,
    'h-[1.5em]': true
  },
  ...
  slider__tooltip: {
    ...
    'after:border-t-priorb-600': true,
  ...
  toggle__track: {
    ...
    'transition-all': true,
    'bg-neutral-400': true,
    'peer-checked:bg-priorb-600': true,
    ...
    'shadow-sm': true,
    'peer-focus-visible:ring-2': true,
    'peer-focus-visible:ring-priorb-200': true,
  ...
  togglebuttons__input: {
    ...
    'dark:disabled:text-gray-900': true,
    'dark:text-gray-900': true,
    'aria-[pressed=true]:bg-priorb-600': true,
    'aria-[pressed=true]:text-white': true,
    'dark:aria-[pressed=true]:bg-priorb-600': true,
    ...
    'group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-priorb-500':
      true,
    'group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-priorb-600':
      true,
    'group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-priorb-600':
      true,
    'dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-priorb-600':
      true,
    'dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-priorb-600':
      true,
    'dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-priorb-600':
      true,
    ...
    'group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-priorb-500':
      true,
    'group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-priorb-600':
      true,
    'group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-priorb-600':
      true,
    'dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-priorb-600':
      true,
    'dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-priorb-600':
      true,
    'dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-priorb-600':
      true
  },
  transferlist__outer: {
    group: true,
    ...
    'text-base': true,
    'max-w-none': true,
    '[&_.dnd-placeholder]:bg-priorb-600': true,
  ...
  transferlist__transferlist: {
    ...
    '[&:has(:focus-visible)]:ring-priorb-200': true,
    'dark:border-neutral-600': true,
  ...
  transferlist__transferlistListItem: {
    ...
    'aria-selected:bg-priorb-100': true,
    'data-[is-active=true]:bg-priorb-100': true,
    ...
    'dark:bg-neutral-800': true,
    'dark:text-neutral-300': true,
    'dark:data-[is-active=true]:bg-priorb-900': true,
    'dark:aria-selected:bg-priorb-900': true,
    'dark:ring-neutral-700': true,
    'dark:data-[is-active=true]:ring-blue-600': true,
    'dark:aria-selected:ring-blue-600': true,
    '[&.formkit-dropZone]:bg-priorb-100': true,
    '[&.formkit-selectionDropZone]:bg-priorb-100': true,
    '[&.formkit-touchDropZone]:bg-priorb-100': true,
    '[&.formkit-touchSelectionDropZone]:bg-priorb-100': true,
    '[&.formkit-longTouch]:bg-priorb-100': true,
    'dark:[&.formkit-dropZone]:bg-priorb-900': true,
    'dark:[&.formkit-selectionDropZone]:bg-priorb-900': true,
    'dark:[&.formkit-touchDropZone]:bg-priorb-900': true,
    'dark:[&.formkit-touchSelectionDropZone]:bg-priorb-900': true,
    'dark:[&.formkit-longTouch]:bg-priorb-900': true
  },
  ...
  transferlist__transferlistSearch: {
    ...
    'dark:border-neutral-600': true,
    'dark:text-neutral-300': true,
    'dark:selection:bg-priorb-100': true,
    'dark:selection:text-neutral-700': true,
    'dark:bg-neutral-800': true
  },
  ...
  'multi-step__tab': {
    ...
    'group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-priorb-600':
      true,
    ...
    'dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-priorb-600':
      true
  },
  ...
  'multi-step__badge': {
    ...
    'text-white': true,
    'rounded-full': true,
    'group-data-[valid=true]/tab:bg-priorb-600': true,
